...
class Registry {
    ...
    async getDiscordRegistrations(array) {
        ...
        return validateMhannResponse(response, 'Issue getting discord registations')
    }
    ...
    async registerDiscordUser(discordId, allyCode) {
        ...
        return validateMhannResponse(response, 'Issure registering discord user')
    }
    ...
    async verifyDiscordUser(discordId, allyCode, isPrimary) {
        ...
        return validateMhannResponse(response, 'Issue verifying discord user')
    }
}
