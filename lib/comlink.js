...
class Comlink {
    ...
    async getTerritoryBattle(latestGamedataVersion = undefined) {
        return (await this.getGameData(2, latestGamedataVersion))['territoryBattleDefinition']
    }

    async getAbility(latestGamedataVersion = undefined) {
        return (await this.getGameData(2, latestGamedataVersion))['ability']
    }
    ...
    async getMaterial(latestGamedataVersion = undefined) {
        return (await this.getGameData(1, latestGamedataVersion))['material']
    }

    async getEquipment(latestGamedataVersion = undefined) {
        return (await this.getGameData(1, latestGamedataVersion))['equipment']
    }
